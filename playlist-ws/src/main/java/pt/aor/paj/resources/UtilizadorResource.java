...
public class UtilizadorResource {
	...
	public Users getUtilizadores() {
		ArrayList<UserEntity> utilizadores = userBean.getUtilizadores();
	...
	@Path("/{userId}")
	@Produces(MediaType.APPLICATION_XML)
	public UserEntity getUtilizador(@PathParam("userId") int id) {
	...
	@Produces(MediaType.APPLICATION_XML)
	public List<PlaylistEntity> getUserPlaylists(@PathParam("userId") int id) {
